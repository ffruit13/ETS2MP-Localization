...
$_lang["mainpage.join"] = "Присоединяйтесь онлайн к тысячам энтузиастов на грузовиках!";
...
$_lang["registration.blocked"] = "Регистрация закрыта - мы всё еще работаем над некоторыми функциями, которые требуют закрытия регистрации. Она будет открыта, когда мы всё сделаем и будем готовы к публикации новой версии.";
...
$_lang["download.no.permissions"] = "Для скачивания необходимо авторизоваться.";
...
$_lang["forum"] = "Форум";
$_lang["cannot.create.account.when.logged"] = "Вы не можете создать новый аккаунт, когда Вы уже авторизованы под своим именем";
$_lang["successfully.registered"] = "Вы успешно зарегистрировались";
$_lang["error.unknown"] = "Неизвестная ошибка";
$_lang["credentials.taken"] = "Ник, E-Mail или SteamID уже использованы.";
$_lang["error.no.steam.data"] = "Для создания аккаунта ETS2MP Вы должны иметь ETS2 в своей библиотеке Steam. Если игра у Вас уже есть, проверьте, открыт ли Ваш профиль Steam. Если он закрытый, откройте его и нажмите";
...
$_lang["unable.to.activate"] = "Невозможно активировать учетную запись, поскольку введён неверный ключ или учетная запись уже активирована.";
...
$_lang["settings.saved.with.mail"] = "Настройки учетной записи сохранены. Проверьте свою электронную почту и заново активируйте Вашу учетную запись.";
...
$_lang["too.short.password"] = "Новый пароль слишком короткий. Требуется минимум 5 символов.";
...
$_lang["contact.message.sent"] = "Спасибо за обращение. Пожалуйста, подождите ответа.";
$_lang["topic"] = "Тема";
