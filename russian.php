...
$_lang["successfully.registered"] = "Вы успешно зарегистрировались.  E-Mail: <b>{0}</b>";
...
$_lang["contact.topic.too.short"] = "Название темы слишком короткое. Оно должно содержать не менее 10 символов";
...
$_lang["error.cannot.fetch.steam.api"] = "Не удалось подключиться к Steam API, повторите позже";
